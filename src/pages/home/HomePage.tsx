...
import { traceContours, generateSVGPath, Color, filterContours } from '../../utils/imageProcessing';
          ...
          {colors.length > 0 && (
            <section className={cn('bg-white', 'rounded-3xl', 'p-6', 'shadow-sm', 'border', 'border-black/5')}>
              ...
              <div className="space-y-3">
                {order.map((colorIdx: number, i: number) => {
                ...
                {layers.map((layer) => (
                  ...
                  >
                    <div className={cn('flex', 'items-center', 'justify-between', 'mb-3')}>
                      ...
                      <button 
                        onClick={(e: React.MouseEvent) => { e.stopPropagation(); downloadSVG(layer); }}
